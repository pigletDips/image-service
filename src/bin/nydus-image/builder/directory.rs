...
impl Builder for DirectoryBuilder {
    fn build(
        ...
        let origion_bootstarp_offset = bootstrap_ctx.offset;
        ...
        // If layered, the bootstrap_ctx.offset will be set, so we need restore it here
        bootstrap_ctx.offset = origion_bootstarp_offset;
